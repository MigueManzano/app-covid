                ...
                <div class="row">
                    ...
                    <div class="col s12 m4">
                        <div class="icon-block">
                            <h2 class="center light-blue-text accent-4"><i
                                    class="material-icons medium">filter_frames</i></h2>
                            <h5 class="center">Diagnóstico</h5>
                            <p class="justify">¿Crees tener sintomas de Covid-19? Tenemos un cuestionario en el cual tu
                                especificas
                    ...
                    <div class="col s12 m4">
                        <div class="icon-block">
                            <h2 class="center light-blue-text accent-4"><i
                                    class="material-icons medium">add_location</i></h2>
                            <h5 class="center">Localización</h5>
                            <p class="justify">¿Necesitas tanques de oxigeno, cubrebocas, oximetro? Te podemos mostrar
                                localizaciones
                    ...
                    <div class="col s12 m4">
                        <div class="icon-block">
                            <h2 class="center light-blue-text accent-4"><i class="material-icons medium">storage</i>
                            </h2>
                            <h5 class="center">Citas</h5>
                            <p class="justify">Agenda tu cita con el doctor de manera en linea, así el podra darte un
                                tratamiento de
            ...
            <section>
                <div class="row">
                    <div class="col s12 m6">
                        ...
                        <p class="justify" style="font-family: Verdana, Geneva, Tahoma, sans-serif;">Se han instalado 17
                            módulos de
                            toma muestra a personas que presenten síntomas del virus SARS-CoV-02 que provoca la
                            enfermedad de
                            Covid-19.</p>
                        <br>
                        <p class="justify" style="font-family: Verdana, Geneva, Tahoma, sans-serif;">Los módulos se
                            ubican en
                            Zócalo, Asta Bandera, La Diana, El Rollo, Plazuela de la Base,
                            Crucero de Puerto Marqúes, Plaza Las Palmas en la Colosio, Colonia Jardin, Calzada Pie de la
                            Cuesta,
                            Iglesia Mozimba, En la Unidad Deportiva Vicente Suárez, Parque La Laja, Iglesia de la
                            Garita, La Cima (20
                            de noviembre),
                        ...
                        <!-- Segundo texto -->
                        <br>
                        <p class="justify" style="font-family: Verdana, Geneva, Tahoma, sans-serif;">La dependencia pide
                            que las
                    ...
                    <div class="col s12 m5 offset-m1" id="frame">
                        <iframe src="https://www.google.com/maps/d/embed?mid=1l1_AvvkNBdXNc9sJputP3p02U6Mntj0p"
                            id="map"></iframe>
                    </div>
                </div>
            </section>
